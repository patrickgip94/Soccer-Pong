...
import { StyleSheet, Image, useWindowDimensions, View, Text, Button } from 'react-native';
import Animated, { 
  Easing,
  useAnimatedStyle, 
  useSharedValue,
...
const islandDimensions = {x: 150, y: 11, w: 100, h: 50};
...
export default function Game() {
  ...
  return (
    <View style={styles.container}>
        ...
        {gameOver && (
          <View styles={styles.gameOverContainer}>
